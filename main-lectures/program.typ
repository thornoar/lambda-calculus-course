...
+ Множество л-выражений. Свободные и связанные переменные. ал-конгруэнтность. Правило переменных.
+ Оператор подстановки.

== Конверсия

+ бэ-конверсия. Теорема о неподвижной точке.
+ Стандартные комбинаторы. Комбинатор неподвижной точки. Формальные л-теории: согласованность, противоречивость, несовместимость.

== Редукция

+ Редукция (б-, эт-, бэ-). Нормальные формы. Редукционные графы.
+ Свойство Чёрча-Россера. Теорема о минимальном элементе.
+ Теорема Чёрча-Россера для б-редукции. Следствия.
+ Диаграммы бинарных отношений. Коммутирующие отношения. Лемма Хиндли-Росена.
+ Теорема Чёрча-Россера для эт- и бэ-редукции. Следствия.
+ Внешние/внутренние редексы и нормальные формы.
+ Стандартный редукционный путь. Существование стандартной редукции.
+ Нормализующая редукционная стратегия. Теорема о нормализации.

= л-представимость

== Основные понятия

+ Комбинаторы $#T$ и $#F$. Упорядоченные пары. Конечные кортежи, проекции.
+ Обобщённая теорема о неподвижной точке.

== Рекурсивные числовые функции

+ Числа Барендрегта (л-числа). л-представимость. Класс рекурсивных функций.
+ Все рекурсивные функции л-представимы.
+ Все л-представимые функции рекурсивны (эскиз доказательства).
+ Кодирование (числа Гёделя), функция комбинации, функция нумерации.
#box(width: 1fr, repeat([$dot$])) _текущий прогресс_

== Числовые системы

+ Числа Чёрча.
+ Числовые системы. Адекватность. Критерий адекватности числовой системы.

== Неразрешимость

+ Рекурсивно сепарабельные и рекурсивные множества. Замкнутость относительно конверсии.
